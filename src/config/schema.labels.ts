...
export const FIELD_LABELS: Record<string, string> = {
  ...
  agents: "Agents",
  "agents.delegationGuard": "Delegation Guard",
  "agents.delegationGuard.enabled": "Delegation Guard Enabled",
  "agents.delegationGuard.mode": "Delegation Guard Mode",
  "agents.delegationGuard.controllers": "Delegation Controllers",
  "agents.delegationGuard.workers": "Delegation Workers",
  "agents.delegationGuard.validator": "Delegation Validator",
  "agents.delegationGuard.validator.sha256": "Delegation Validator SHA-256",
  "agents.delegationGuard.validator.entrypoint": "Delegation Validator Entrypoint",
  "agents.delegationGuard.validator.maxOutputBytes": "Delegation Validator Output Limit",
