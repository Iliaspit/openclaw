...
describe("QmdMemoryManager", () => {
  ...
  it("rebinds a managed collection when its root path changed and show reveals old path", async () => {
  ...
  it("rebinds a stale in-container collection root to the host workspace", async () => {
