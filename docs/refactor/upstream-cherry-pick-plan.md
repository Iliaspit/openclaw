...
| Planned  | `f658abae50` + `e7f1b24d9d` | Suppress internal protocol artifacts from user-facing replies.          | `pnpm test src/auto-reply/tokens.test.ts src/auto-reply/reply/reply-utils.test.ts extensions/telegram/src/bot-message-dispatch.test.ts --run`                                  |
